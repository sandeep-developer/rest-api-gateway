...
public class BDPToFGBookingApiClient {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			String jsonUpdateString = "{ \"db_id\": 20}";
			String jsonDeleteString = "{ \"db_id\": 20}";
